...
//		*****************************************************************************************
/*int obtenerCadenaVersionMalloc(char* cadena, int limite, char* mensajeFallo){
	int retorno=-1;
...
int conseguirEntero(int* pEntero, char* mensajeFallo){
	...
	if(pEntero!=NULL &&	mensajeFallo!=NULL &&
			!obtenerCadena(bufferString, sizeof(bufferString), mensajeFallo) && esEntero(bufferString, sizeof(bufferString), mensajeFallo)){
...
int conseguirFlotante(float* pFlotante, char* mensajeFallo){
	...
	if(pFlotante!=NULL && mensajeFallo!=NULL &&
			!obtenerCadena(bufferString, sizeof(bufferString), mensajeFallo) && esFlotante(bufferString, sizeof(bufferString), mensajeFallo)){
...
int conseguirNombre(char* pNombre, int limite, char* mensajeFallo){
	...
	if(pNombre!=NULL && limite>0 && mensajeFallo!=NULL &&
			!obtenerCadena(bufferString, limite, mensajeFallo) && esNombre(bufferString, limite, mensajeFallo)){
		strncpy(pNombre, bufferString, limite);
		retorno=0;
	}
	return retorno;
...
int conseguirDescipcion(char* pDescripcion, int limite, char* mensajeFallo){
	...
	if(pDescripcion!=NULL && limite>0 && mensajeFallo!=NULL &&
			!obtenerCadena(bufferString, limite, mensajeFallo) && esDescripcion(bufferString, limite, mensajeFallo)){
		strncpy(pDescripcion, bufferString, limite);
		retorno=0;
	}
	return retorno;
...
int conseguirAlfanumerico(char* pAlfanumerico, int limite, char* mensajeFallo){
	...
	if(pAlfanumerico!=NULL && limite>0 && mensajeFallo!=NULL &&
			!obtenerCadena(bufferString, limite, mensajeFallo) && esAlfanumerico(bufferString, limite, mensajeFallo)){
		strncpy(pAlfanumerico, bufferString, limite);
		retorno=0;
	}
	return retorno;
